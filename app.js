...
productImageInput.addEventListener("change", (e) => handleImageUpload(e, "product"));
...
function drawProductName(text, x, y, maxWidth, theme) {
  ...
  let fontSize = selectedFormat === "story" ? 62 : selectedFormat === "portrait" ? 56 : 44;
  const minSize = 28;
...
function drawPriceGroup(price, oldPrice, layout, theme) {
  ...
  if (!currency) {
    fitTextCenter(amount, centerX, centerY, w - 60, selectedFormat === "story" ? 118 : selectedFormat === "portrait" ? 104 : 82, 34, 900);
    return;
  }
